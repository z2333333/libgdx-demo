 ...
 */
public class BitmapFontAlignmentTest extends ApplicationAdapter{
    ...
    public void create () {
        ...
        font = new BitmapFont(Gdx.files.getFileHandle("data/verdana39.fnt", Files.FileType.Internal), Gdx.files.getFileHandle(
                "data/verdana39.png", Files.FileType.Internal), false);
    ...
    public static void main (String[] args) throws Exception {
        new LwjglApplication(new BitmapFontAlignmentTest());
    }
}
