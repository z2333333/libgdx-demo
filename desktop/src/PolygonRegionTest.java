 ...
 * @Date: 2019/8/8 10:11
 */
public class PolygonRegionTest extends ApplicationAdapter {
    ...
    public void create () {
        ...
        //region2 = new PolygonRegion(new TextureRegion(texture), new float[] {0, 0, 100, 100, 0, 100,-100,0,0,0}, new short[] {0, 1, 2,2,3,4});
        region2 = new PolygonRegion(new TextureRegion(texture), new float[] {0, 0,100,0,100,100,0,100,0,0}, new short[] {0, 1, 2,0,2,3});
    ...
    public static void main (String[] args) throws Exception {
        new LwjglApplication(new PolygonRegionTest());
    }
}
